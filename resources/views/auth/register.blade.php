...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center my-3">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header font-weight-bold">{{ __('Register User') }}</div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <select class="custom-select form-select-lg mb-3" id="privilege" name="privilege">
                                        <option value=1>Admin</option>
                                        <option value=2>Priviliged User</option>
