            ...
            <div class = 'col-md-10'>
                ...
                <form action="{{ route('edit_configuration_submit') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                        <input id="admin_borrow_no" name="admin_borrow_no" type="number" step="0" min="0" max="100" required
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                        <input id="admin_borrow_duration" name="admin_borrow_duration" type="number" step="0" min="0" max="100" required
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                        <input id="privileged_borrow_no" name="privileged_borrow_no" type="number" step="0" min="0" max="100" required
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                        <input id="privileged_borrow_duration" name="privileged_borrow_duration" type="number" step="0" min="0" max="100" required
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                        <input id="regular_borrow_no" name="regular_borrow_no" type="number" step="0" min="0" max="100" required
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                        <input id="regular_borrow_duration" name="regular_borrow_duration" type="number" step="0" min="0" max="100" required
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                        <input id="late_fees_base" name="late_fees_base" type="number" step="0.01" min="0" max="100" required
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                        <input id="late_fees_increment" name="late_fees_increment" type="number" step="0.01" min="0" max="100" required
