...
<body>
    ...
    <div class="container">
        <div class='row justify-content-center my-3'>
            <div class = 'col-md-8'>
                <h1><font face='Impact'>Add Reward</font></h1>
                <form action="{{ route('add_reward_submit') }}" method="post" enctype="multipart/form-data"
                onSubmit="return confirm('Are you sure you wish to Add this Reward?');">
                    @csrf
                    <!-- Print error message that Reward was NOT added -->
                    @if(Session::has('Fail'))
