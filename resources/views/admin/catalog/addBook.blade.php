    ...
    <div class="container">
        <div class='row justify-content-center my-3'>
            <div class = 'col-md-8'>
                ...
                onSubmit="return confirm('Are you sure you wish to Add Book?');">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            ...
                            class="form-control" required value="{{ old('publication_date') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <input id="price" name="price" type="number" step="0.01" min="0" max="100" required
                            ...
                            <div id="sliderBox">
                                <input type="range" id="priceSlider" step="0.01" min="0" max="100" value="{{ old('price') }}" class="form-control">
                            </div>
                        </div>
